...
\usepackage[margin=1.32cm]{geometry}
...
\titlespacing*{\section}{0pt}{0.72em}{0.38em}

\newcommand{\cvitem}[4]{%
  \begin{tabularx}{\textwidth}{@{}p{2.18cm}X@{}}
    {\color{lightgray}\small #1} &
    \textbf{#2}{\color{lightgray}\small\quad #3}\\
    & {\color{textgray}\small #4}
  \end{tabularx}\vspace{0.26em}
}
...
\newcommand{\compactlist}{%
  \begin{itemize}[leftmargin=1.05em,itemsep=0.12em,topsep=0.1em]
}
...
\begin{enumerate}[leftmargin=1.25em,itemsep=0.2em,topsep=0.1em]
...
\cvitem{Year 1}{Foundations in TES modeling, Kapitza laws, and topology optimization}{}{Derived and numerically verified steady and transient heat-conduction models; implemented one- and two-dimensional FreeFEM++ simulations; incorporated radiative heat transfer through Stefan-Boltzmann-type nonlinear terms; studied nonlinear Kapitza contact resistance in double-layer domains; demonstrated non-uniqueness in scalar models; used Picard iteration and bifurcation analysis to identify transcritical, pitchfork, flip, and saddle-node bifurcations; studied topological derivatives via Dirichlet-to-Neumann operators and implemented a two-dimensional transient heat-conduction topology optimization prototype.}
\cvitem{Year 2}{Kapitza FEM, continuation, topological derivatives, and XPINN methods}{}{Developed FreeFEM and Matlab tools for linear and nonlinear Kapitza interface problems; analyzed convergence limitations of Newton and classical continuation methods under multiple branches and turning points; adopted pseudo-arclength continuation to track folds and difficult branches; implemented topological-derivative criteria for inclusion insertion and material modification; built XPINN solvers for steady and time-dependent variable-coefficient heat conduction; consolidated weak formulations, interface terms, and finite element discretization of the linear Kapitza problem; clarified the role of PINN/XPINN methods as complementary tools for heterogeneous media, surrogate modeling, and optimization-driven simulations.}
\cvitem{Training}{Doctoral training and scientific activities}{}{Completed training in problem-solving tools, random modeling, French A1/A2, scientific Python and JupyterLab, CIMPA Mathematics-AI school, and advanced mechanics of solids, fluids, structures and flexible multibody systems; participated in FreeFEM Days, ANR NumOpTES meeting, a winter school on control/optimization/AI, and LMAC doctoral seminars.}
